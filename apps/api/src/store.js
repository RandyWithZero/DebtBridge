...
export function toPartnerListItem(organization) {
  return {
    ...
    minInstallmentMonths: organization.minInstallmentMonths,
    maxInstallmentMonths: organization.maxInstallmentMonths,
    averageProcessingDays: organization.averageProcessingDays,
    cooperationModes: organization.cooperationModes,
